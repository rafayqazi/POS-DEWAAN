...
<head>
    ...
    <title>Terms & Conditions - <?= getSetting('business_name', 'Fashion Shines') ?></title>
...
<div class="max-w-5xl mx-auto space-y-8">
    ...
    <div class="text-center mb-12">
        <h1 class="text-4xl font-black text-teal-800 tracking-tighter"><?= getSetting('business_name', 'Fashion Shines') ?></h1>
            ...
            <div class="license-card p-8">
                ...
                <div class="legal-section">
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed">
                        All source code, designs, and logical structures of "<?= getSetting('business_name', 'Fashion Shines') ?>" are the exclusive property of <strong>Abdul Rafay (The Developer)</strong>. Under copyright law, you are granted a license to USE the software, not own its code.
                    </p>
                </div>
